...
install_docker() {
    colorized_echo blue "Installing Docker (official repo)"
    ...
    if [[ "$OS" == "Ubuntu"* ]] || [[ "$OS" == "Debian"* ]]; then
        ...
        colorized_echo red "Docker auto install not supported for this OS"
        exit 1
    fi
...
install_marzban_script() {
    FETCH_REPO="xsm-syn/Marzban-scripts"
...
install_marzban() {
    # Fetch releases
    FILES_URL_PREFIX="https://raw.githubusercontent.com/xsm-syn/marzban-set/main"
